...
import impacta.exceptions.AcaoLotadaException;
import impacta.exceptions.EmailDuplicadoException;
import impacta.exceptions.InscricaoDuplicadaException;
import impacta.sistema.Impacta;
...
public class Testes {
    ...
    public void testCalculoPontuacaoPolimorfico() {
        ...
        int idPlantio = sistema.cadastrarPlantio(
                "Plantio", "Descrição", "10/10/2026 10:00", 5, 10
        );

        // Mutirão: 4 * 3 horas = 12 pontos
        int idMutirao = sistema.cadastrarMutirao(
                "Mutirão", "Descrição", "11/10/2026 10:00", 5, 3
        );

        // Oficina com kit: (3 * 2 horas) + 10 bônus = 16 pontos
        int idOficinaComKit = sistema.cadastrarOficina(
                "Oficina Kit", "Descrição", "12/10/2026 10:00", 5, 2, true
        );

        // Oficina sem kit: (3 * 2 horas) = 6 pontos
        int idOficinaSemKit = sistema.cadastrarOficina(
                "Oficina Sem Kit", "Descrição", "13/10/2026 10:00", 5, 2, false
        );
    ...
    public void testOrdenacaoRankingVoluntarios() {
        ...
        int idPlantio = sistema.cadastrarPlantio(
                "Plantio A", "Desc", "10/10/2026 10:00", 10, 20
        ); // 45 pts

        int idMutirao = sistema.cadastrarMutirao(
                "Mutirão B", "Desc", "11/10/2026 10:00", 10, 5
        ); // 20 pts
        ...
        // Carlos em 1º, Bruno em 2º e Ana em 3º
    ...
    public void testDesempatePorNomeRanking() {
        ...
        int idMutirao = sistema.cadastrarMutirao(
                "Mutirão", "Desc", "11/10/2026 10:00", 10, 5
        ); // 20 pts
        ...
        // Ambas possuem 20 pts, então Alice vem primeiro
    ...
    public void testExcecoesInscricao() {
        ...
        int idAcao = sistema.cadastrarPlantio(
                "Acao Pequeña", "Desc", "10/10/2026 10:00", 1, 5
        );

        sistema.inscreverVoluntario("maria@email.com", idAcao);

        // Tentar inscrever o mesmo aluno novamente
    ...
    public void testExcecaoEmailDuplicado() {
        ...
        assertThrows(EmailDuplicadoException.class, () -> {
            sistema.cadastrarVoluntario(
                    "Outro Lucas", "lucas@email.com", "222"
            );
        });
    }
    ...
    public void testEmailDuplicadoLancaExcecao() {
        sistema.cadastrarVoluntario(
                "João Silva", "joao@impacta.org", "1001"
        );

        assertThrows(EmailDuplicadoException.class, () -> {
            sistema.cadastrarVoluntario(
                    "João Pedro", "joao@impacta.org", "1002"
            );
    ...
    public void testExibirVoluntarioInexistente() {
        String resultado = sistema.exibirVoluntario(
                "fantasma@impacta.org"
        );

        assertNotNull(resultado);

        assertTrue(
                resultado.toLowerCase().contains("não encontrado"),
    ...
    public void testCalculoPlantioMudas() {
        ...
        // 0 mudas = 5 pontos
        int id1 = sistema.cadastrarPlantio(
                "Plantio Zero",
                "Desc",
                "10/10/2026 10:00",
                10,
        ...
        int id2 = sistema.cadastrarPlantio(
                "Plantio Grande",
                "Desc",
                "10/10/2026 10:00",
                10,
        ...
        sistema.inscreverVoluntario(
                "ana@impacta.org",
                id1
        );

        assertTrue(
                sistema.exibirVoluntario("ana@impacta.org")
                        .contains("Pontuação: 5")
        );
    ...
    public void testCalculoMutiraoReciclagem() {
        ...
        // 5 horas = 20 pontos
        int id = sistema.cadastrarMutirao(
                "Recicla",
                "Desc",
                "10/10/2026 10:00",
                5,
        ...
        assertTrue(
                sistema.exibirVoluntario("beto@impacta.org")
                        .contains("Pontuação: 20")
        );
    }
    ...
    public void testCalculoOficinaEcologica() {
        ...
        int idSemKit = sistema.cadastrarOficina(
                "Oficina A",
                "Desc",
                "10/10/2026 10:00",
                5,
        ...
        int idComKit = sistema.cadastrarOficina(
                "Oficina B",
                "Desc",
                "10/10/2026 10:00",
                5,
        ...
        assertTrue(
                sistema.exibirVoluntario("caio@impacta.org")
                        .contains("Pontuação: 12")
        );
    ...
    public void testDuplaInscricaoLancaExcecao() {
        ...
        int idAcao = sistema.cadastrarMutirao(
                "Mutirão Bairro",
                "Desc",
                "10/10/2026 09:00",
                10,
    ...
    public void testRankingPontuacaoEDesempate() {
        ...
        int acao50 = sistema.cadastrarPlantio(
                "Plantio",
                "Desc",
                "10/10/2026 10:00",
                10,
        ...
        int acao10 = sistema.cadastrarOficina(
                "Oficina",
                "Desc",
                "10/10/2026 10:00",
                10,
        ...
        assertEquals(
                4,
                ranking.length,
                "O ranking deve listar todos os 4 voluntários."
        );

        assertTrue(
                ranking[0].contains("Carlos"),
                "1º lugar deve ser Carlos."
        );

        assertTrue(
                ranking[1].contains("Amanda"),
                "2º lugar deve ser Amanda."
        );

        assertTrue(
                ranking[2].contains("beatriz"),
                "3º lugar deve ser beatriz."
        );

        assertTrue(
                ranking[3].contains("Daniel"),
                "4º lugar deve ser Daniel."
        );
    }
    ...
    public void testAcumuloDeAcoesEPontos() {
        ...
        int acao1 = sistema.cadastrarMutirao(
                "M1",
                "Desc",
                "10/10/2026 10:00",
                5,
        ...
        int acao2 = sistema.cadastrarMutirao(
                "M2",
                "Desc",
                "10/10/2026 10:00",
                5,
        ...
        String detalhes = sistema.exibirVoluntario(
                "nanda@impacta.org"
        );

        assertTrue(
                detalhes.contains("Ações Participadas: 2"),
                "Deve registrar 2 ações."
        );

        assertTrue(
                detalhes.contains("Pontuação: 20"),
                "Deve acumular 20 pontos."
        );
    }
    ...
    @Test
    @DisplayName("Deve lançar exceção quando a String de data for inválida")
    public void testDataInvalidaLancaExcecao() {

        // Formato inválido propositalmente.
        // O sistema espera: dd/MM/yyyy HH:mm
        assertThrows(DateTimeParseException.class, () -> {
            sistema.cadastrarMutirao(
                    "Mutirão",
                    "Desc",
                    "2026-10-10T10:00:00",
                    5,
